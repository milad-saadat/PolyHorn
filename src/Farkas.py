...
class Farkas:
    ...
    def __init__(self, variables: [UnknownVariable], LHS: [PolynomialConstraint], RHS: PolynomialConstraint):
        self.variables = variables
        self.RHS = RHS
        self.LHS = LHS

    def get_poly_sum(self, need_strict: bool = False) -> (Polynomial, CoefficientConstraint):
        ...
        sum_of_strict = Solver.get_constant_polynomial(self.variables, '0') + new_var
